        ...
        return (
          <section key={screen.id}>
            <button
              ...
              className={`press mb-1 w-full break-words rounded-[16px] bg-[var(--chrome)] px-3 py-2 text-left text-[15px] font-medium ${selectedScreen ? "text-[var(--accent)]" : "text-[var(--ink)]"}`}
              title={screen.name}
            >
              {screen.name}
            </button>
