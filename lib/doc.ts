...
export function defaultDoc(lang: Lang): Doc {
  ...
  const gallery: Screen = {
    ...
    items: [
      ...
      item("smallTitle", 0, 84, 412, 40, loc(lang, "滑块", "Slider", "スライダー", "슬라이더")),
      item("slider", 16, 132, 380, 28, "", { value: 0.6, variant: "horizontal" }),
      item("rangeSlider", 16, 172, 380, 28, "", { value: 0.8, from: 0.2 }),
      item("smallTitle", 0, 216, 412, 40, loc(lang, "进度", "Progress", "進捗", "진행")),
      item("progress", 16, 264, 380, 6, "", { variant: "linear", value: 0.45 }),
      item("progress", 16, 284, 32, 32, "", { variant: "circular" }),
      item("progress", 60, 290, 20, 20, "", { variant: "infinite" }),
