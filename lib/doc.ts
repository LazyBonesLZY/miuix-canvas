...
export function defaultDoc(lang: Lang): Doc {
  ...
  const home: Screen = {
    ...
    items: [
      ...
      item("smallTitle", 0, 132, 412, 36, "Switch"),
      ...
      item("smallTitle", 0, 288, 412, 36, "Checkbox / RadioButton"),
      ...
      item("smallTitle", 0, 444, 412, 36, "Button"),
      ...
      item("smallTitle", 0, 542, 412, 36, "TabRow"),
      ...
      item("smallTitle", 0, 628, 412, 36, "Other"),
      item("arrowPref", 16, 664, 380, 64, "PullToRefresh", {
  ...
  const gallery: Screen = {
    ...
    items: [
      ...
      item("smallTitle", 0, 80, 412, 36, "Slider"),
      item("slider", 16, 124, 380, 28, "", { value: 0.6, variant: "horizontal" }),
      item("smallTitle", 0, 164, 412, 36, "ProgressIndicator"),
      item("progress", 16, 208, 380, 6, "", { variant: "linear", value: 0.45 }),
      item("progress", 16, 228, 30, 30, "", { variant: "circular" }),
      item("progress", 56, 233, 20, 20, "", { variant: "infinite" }),
      item("smallTitle", 0, 272, 412, 36, "ColorPalette"),
      item("colorPalette", 16, 312, 380, 96, ""),
      item("smallTitle", 0, 420, 412, 36, "NumberPicker / Blur"),
      item("numberPicker", 36, 464, 160, 140, "12"),
      item("blur", 216, 464, 180, 140, "textureBlur"),
