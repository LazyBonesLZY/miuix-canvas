...
const ZH = {
  ...
  resetConfirm: "重置",
  zoom: "缩放",
  emptyCanvas: "还没有屏幕。点上方手机或桌面按钮，或从左侧拖入一个部件。",
...
const EN: Record<keyof typeof ZH, string> = {
  ...
  resetConfirm: "Reset",
  zoom: "Zoom",
  emptyCanvas: "No screens yet. Add a phone or desktop above, or drop a part from the left.",
...
const JA: Record<keyof typeof ZH, string> = {
  ...
  web: "Web (CMP)",
  lang: "言語",
  empty: "左から部品をドラッグするか、クリックしてこの画面に置きます。",
  ...
  resetConfirm: "リセット",
  zoom: "ズーム",
  emptyCanvas: "画面がありません。上のスマホ／デスクトップを押すか、左から部品を置いてください。",
...
const KO: Record<keyof typeof ZH, string> = {
  ...
  web: "Web (CMP)",
  lang: "언어",
  empty: "왼쪽에서 부품을 끌어오거나 클릭해서 이 화면에 놓으세요.",
  ...
  resetConfirm: "재설정",
  zoom: "확대",
  emptyCanvas: "화면이 없습니다. 위의 휴대폰/데스크톱을 누르거나 왼쪽에서 부품을 놓으세요.",
...
const KIND_EN: Record<Kind, string> = {
  ...
  listPopup: "ListPopup",
  cascadingPopup: "Cascading ListPopup",
...
const KIND_JA: Record<Kind, string> = {
  ...
  listPopup: "リストポップアップ ListPopup",
  cascadingPopup: "カスケードメニュー ListPopup",
  dropdownMenu: "ドロップダウンメニュー DropdownMenu",
  ...
  dropdownPref: "ドロップダウン設定 SpinnerPreference",
...
const KIND_KO: Record<Kind, string> = {
  ...
  listPopup: "목록 팝업 ListPopup",
  cascadingPopup: "계단식 메뉴 ListPopup",
  dropdownMenu: "드롭다운 메뉴 DropdownMenu",
  tooltip: "툴팁 Tooltip",
  ...
  dropdownPref: "드롭다운 설정 SpinnerPreference",
